<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhuye1.aspx.cs" Inherits="情侣博客.html.zhuye1" %>
...
<head runat="server">
    ...
    <!-- 通过自有函数输出HTML头部信息 -->
    <meta name="description" content="祝福版">
    ...
    <link rel="alternate" type="application/rss+xml" title="祝福版 &raquo;  &raquo; RSS 2.0" href="https://mishi23.com/index.php/feed/4.html">
    <link rel="alternate" type="application/rdf+xml" title="祝福版 &raquo;  &raquo; RSS 1.0" href="https://mishi23.com/index.php/feed/rss/4.html">
    <link rel="alternate" type="application/atom+xml" title="祝福版 &raquo;  &raquo; ATOM 1.0" href="https://mishi23.com/index.php/feed/atom/4.html">
            ...
            window.TypechoComment = {
                ...
                reply: function (cid, coid) {
                    var comment = this.dom(cid), parent = comment.parentNode,
                        response = this.dom('respond-page-4'), input = this.dom('comment-parent'),
                ...
                cancelReply: function () {
                    var response = this.dom('respond-page-4'),
    ...
    <form id="form1" runat="server">
                ...
                <div class="row align-items-center pb-5 lover">
                    ...
                    <div class="col">
                        <div class="d-flex flex-column">
                            ...
                            <h4 class="mx-auto text-white pt-2">
                                <asp:Label ID="Label4" runat="server" Text="Label">瑶瑶</asp:Label>
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <div id="Pjax">
            ...
            <style>
                @font-face {
                    font-family: FontStyle;
                    src: url("static/font/zhanku.ttf");
                }
            ...
            <script type="text/javascript" src="static/js/mishi1.js"></script>
            <div id="respond-page-4" class="respond list-content mx-auto mt-5">
                <div class="list-top">
                    <h5 class="text-center" style="background: linear-gradient(to right, #ff00008f, #007bff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">累计已经收到<span class="bigfontNum">
                        <asp:Label ID="Label5" runat="server" Text="Label">31</asp:Label>
                    </span>条祝福</h5>
                        ...
                        <ContentTemplate>
                            <ul>
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <li id="hz">
                                            <span><b><%# Eval("Name") %></b> - <%# Eval("Sj") %></span>
                                            <br />
                                            <br />
                                            <p><%# Eval("Nr") %></p>
                                            <br />
                                            <div id="dz">
                                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../img/2.png" Width="50" Height="50" CommandArgument='<%# Eval("Id") %>' OnClick="ImageButton1_Click" />
                                                <span style="color: red">点赞<%#Eval("Sum")%></span></li>
                                        <hr />
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
                    ...
                    <script>
                        ...
                        hideBoxButton.addEventListener("click", function () {
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <br />
                            <br />
                            <asp:Button ID="Button1" runat="server" Text="发送"  OnClick="Button1_Click5"/>
